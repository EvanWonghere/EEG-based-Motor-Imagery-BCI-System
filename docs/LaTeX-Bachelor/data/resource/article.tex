...
\setcounter{section}{1}  % 第一章为占位，正文从第二章开始
...
\text{reject if} \quad \max_{c,t}|x_c(t)| - \min_{c,t}|x_c(t)| > \theta
\end{equation}
当任一 EEG 通道在一个 epoch 内的峰峰值超过阈值 $\theta = 100\,\mu\text{V}$ 时，该 epoch 被标记为坏段并排除。
